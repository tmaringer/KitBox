...
CREATE TABLE `crossbars` (
  `CrossbarId` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `crossbars` VALUES (1,4,'TRF42','HF'),(2,4,'TRF42','LF'),(3,4,'TRG42','HL'),(4,4,'TRG42','HR'),(5,4,'TRG42','LL'),(6,4,'TRG42','LR'),(7,4,'TRR42','HB'),(8,4,'TRR42','LB');
...
-- Dump completed on 2020-03-22 15:54:42
