...
namespace UnitTest
{
    ...
    public class OrderFormTest
    {
        ...
        public void testsInitialize()
        {
            ...
            crossBarWithParam1 = new CrossBar(100, "referenceTest", "1", new ComponentSize(10, 0, 0), false, 0, CrossBarType.side);
            crossBarWithParam2 = new CrossBar(100, "referenceTest", "1", new ComponentSize(0, 0, 0), false, 0, CrossBarType.side);
